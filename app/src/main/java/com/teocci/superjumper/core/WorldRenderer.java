...
package com.teocci.superjumper.core;
...
public class WorldRenderer
{
    ...
    private void renderBob()
    {
        ...
        if (side < 0)
            batch.draw(keyFrame, world.bob.position.x + 0.5f, world.bob.position.y - 0.5f, side *
					1, 1);
        else
            batch.draw(keyFrame, world.bob.position.x - 0.5f, world.bob.position.y - 0.5f, side *
					1, 1);
    ...
    private void renderPlatforms()
    {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (platform.state == Platform.PLATFORM_STATE_PULVERIZING) {
                keyFrame = Assets.brakingPlatform.getKeyFrame(platform.stateTime, Animation
    ...
    private void renderItems()
    {
        ...
        for (int i = 0; i < len; i++) {
            ...
            TextureRegion keyFrame = Assets.coinAnim.getKeyFrame(coin.stateTime, Animation
					.ANIMATION_LOOPING);
